    ...
    <div className="max-w-5xl mx-auto p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {items.map(i => (
            <div key={i.productId} className="flex gap-4 border rounded p-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-muted-foreground mb-1">${(typeof i.price === 'number' ? i.price : Number(i.price) || 0).toFixed(2)}</div>
        ...
        <aside className="border rounded p-4 h-max">
          ...
          <Button className="w-full" disabled={count === 0} onClick={() => router.push('/checkout')}>Checkout</Button>
